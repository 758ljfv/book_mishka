    ...
    <div class="antiscroll-wrap">
      ...
      <div class="antiscroll-inner">
        ...
        <div class="content">
          ...
          <h4 class="about-text">I am a <span class="label">theoretical physicist</span> developed the general theory of relativity, effecting a revolution in physics.</h4>
          ...
          <div class="history-group">
            ...
            <div class="history-unit">
              ...
              <h4 class="work-time">since 2011</h4>
            ...
            <div class="history-unit">
              ...
              <h4 class="work-time">2007 - 2011</h4>
            ...
            <div class="history-unit">
              ...
              <h4 class="work-time">2002 - 2007</h4>
          ...
          <div class="history-group">
            ...
            <div class="history-unit">
              ...
              <h4 class="work-time">2000 - 2002</h4>
            ...
            <div class="history-unit">
              ...
              <h4 class="work-time">1996 - 2000</h4>
          ...
          <!-- DOWNLOAD BUTTON -->
          <div class="launch">
            <a href="index.html#" class="btn">DOWNLOAD CV</a>
          </div>
          <!-- DOWNLOAD BUTTON -->
          ...
          <div class="testo-group">
            <!-- Testimonial -->
            <div class="testo">
              <img src="./../../assets/book/images/site/testo-01.jpg" alt="someone">
              <div class="text">
            ...
            <!-- Testimonial -->
            <div class="testo">
              <img src="./../../assets/book/images/site/testo-02.jpg" alt="someone">
              <div class="text">
            ...
            <!-- Testimonial -->
            <div class="testo">
              <img src="./../../assets/book/images/site/testo-03.jpg" alt="someone">
              <div class="text">
